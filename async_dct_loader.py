...
async def async_load_dct_paths(nhcpp_objs, all_paths, num_threads=8, dct_dim=32, min_img_dims=128, tqdm_vers = tqdm_nb, ret_hash=False, pil_sz=-1, phsz=0):
    global nhcpp_objs_g
