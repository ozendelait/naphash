...
RUN conda update conda && \
    conda install jupyter==1.0.0 pybind11 
RUN conda install -c fastai fastcore==1.2.5 nvidia-ml-py3 nbdev==1.1.4 timm==0.4.12 
RUN conda install -c conda-forge imageio==2.6.1 
